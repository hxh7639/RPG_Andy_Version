...
namespace RPG.Characters
{
    ...
    public class WeaponPickupPoint : MonoBehaviour
    {
        ...
        void OnTriggerEnter()
        {
            FindObjectOfType<PlayerControl>().GetComponent<WeaponSystem>().PutWeaponInHand(weaponConfig);  // andy. using findobject of type will cause the weapon to be put into random hands
